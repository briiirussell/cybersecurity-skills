...
**Triggers:** 'disk forensics', 'forensic analysis', 'disk image', 'file carving', 'deleted files', 'forensic investigation', 'evidence recovery', 'autopsy', 'sleuthkit', 'forensic image'
**Domain:** forensics

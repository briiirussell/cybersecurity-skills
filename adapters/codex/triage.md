...
Use this instruction set when the task involves: incident response, security incident, triage, we've been hacked, breach, compromised, malware detected, suspicious activity, IOC, indicators of compromise

## Authorization

For defensive use by incident responders, SOC analysts, and system administrators on systems they are authorized to manage.
